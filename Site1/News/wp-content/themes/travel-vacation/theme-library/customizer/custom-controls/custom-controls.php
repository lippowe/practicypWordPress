...
if ( class_exists( 'WP_Customize_Section' ) ) {
	...
	class Travel_Vacation_Upsell_Section extends WP_Customize_Section {
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="travel_vacation_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
