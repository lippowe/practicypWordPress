...
$number_of_footer_columns = get_theme_mod('luxury_hotels_footer_columns', 4); // Change this value as needed.
...
?>
<div class="container">
    <aside class="widget-area row pt-3" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'luxury-hotels' ); ?>">
